...
def main(is_mobilenetV2):
    ...
    newimgpath = '../data2020/new_image_data2020_aug/'  ## 数据增强至文件夹
    ...
    train_batch_size = 16
    val_batch_size = 64
    root_model_path = './model_other_V2/'
    last_model_path = './js_model_other_V2'
    best_model_path = './js_model_best_other_V2'
